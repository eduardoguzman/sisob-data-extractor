...
{   
    private static final Logger LOG = Logger.getLogger(FileFormatConversor.class.getName());
    ...
    {   
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error iterating document to create '" + filePathCSV + "'");
        }        
        return success;
    }
    ...
    {   
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error create writer to create '" + filePathCSV + "' " + ex.getMessage());
            writer = null;                        
        }
        ...
        if(writer != null && writer_nofound != null)
        {
            for(int i = 0; i < fileXmlDocuments.length; i++) 
            {
                ...
                try {
                    ...
                    LOG.log(Level.SEVERE, "Error opening xml document '" + fileXmlDocuments[i].getPath() + "' to create '" + filePathCSV + "' " + ex.getMessage());
                    doc = null;
                }                
                ...
                if(doc != null)
                {
                    ...
                    try {
                        ...
                        LOG.log(Level.SEVERE, "Error iterating document to create '" + filePathCSV + "' " + ex.getMessage());
                    }        
