 ...
 */
public class cUtils {
    private static final Logger LOG = Logger.getLogger(cUtils.class.getName());
     ...
     public static boolean bLock = false;
       public static List createCorpusFromListContent(List<Object[]> lstContent, int iTextIndex) throws Exception
       {
            ...
            {      
                ...
                {
                    LOG.log(Level.SEVERE, ex.getMessage() + " file: " + ((String)ao[iTextIndex]).replace("#", "%23"));
                    doc = null;
                }
                ...
                if(doc != null && doc.getContent().size() < 39000)
                {
                    ...
                    {
                        LOG.log(Level.WARNING, ((String)ao[iTextIndex]).replace("#", "%23") + " is empty.");
                    }
                }
            }
