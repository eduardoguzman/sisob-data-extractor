...
*/
/*
    This class was initially developed by Dipartimento di Informatica. 
    Università degli Studi di Milano.(http://dsiutils.di.unimi.it/docs/overview-summary.html).
    It was released under GNU Lesser General Public License. 
    The original class however didn't allow overriding.
 */
