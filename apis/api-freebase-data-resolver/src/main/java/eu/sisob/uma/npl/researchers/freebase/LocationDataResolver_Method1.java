...
{ 
    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(LocationDataResolver_Method1.class.getName());        
