...
{
    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(DataResearcherAugmentedInformation.class.getName());
                 ...
                 {      
                    ...
                    if(location != null)
                    {
                        ...
                        {                            
                            ...
                            LOG.info("\tChange '" + key + "' with '" + place.getText() + "' by " + value);   
                            place.setText(value);
                            }
                        }
                    } 
    ...
    {   
        ...
        for ( Iterator i = root.elementIterator("blockinfo"); i.hasNext(); )
        {
             ...
             {                 
                 ...
                 {      
                    LOG.info("\tTry to resolve => " + title_name);
                    ...
                    if(id_type != null)
                    {
                        ...
                        LOG.info("\tResolve => " + title_name + " => " + standard_type);
                        ...
                        if(position == null) {
                            ...
                            LOG.info("\tChange '" + key + "' with '" + position.getText() + "' by " + value);   
                        }                       
                    }
                 }
             }
