...
{   
    private static final Logger LOG = Logger.getLogger(TextMiningParserGateResearcher.class.getName());
    ...
    {       
        ...
        try
        {
            ...
            //Resource res = Factory.createResource("gate.creole.tokeniser.DefaultTokeniser", params);
            Resource res = Factory.createResource("gate.creole.tokeniser.DefaultTokeniser");
            pr = (ProcessingResource)res;
            annieController.add(pr);
