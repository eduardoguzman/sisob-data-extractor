...
{        
    private static final Logger LOG = Logger.getLogger(GateDataExtractorTask.class.getName());
    ...
    @Override
        public void executeTask() 
        {
                ...
                try 
                {
                    ...
                    @Override
                        ...
                        {                        
                            ...
                            LOG.info("uncaughtException: " + e.getMessage());                        
                        }
                    };
                    ...
                    if(this.use_dataresolver && this.credentials_academic_trad_tables != null)
                    {
                        ...
                        try{
                            ...
                            LOG.log(Level.SEVERE, "Error resolving locator. " + ex.toString());
                        }
                    ...
                    if(this.use_academic_trad_tables && this.credentials_academic_trad_tables != null)
                    {
                        ...
                        try{
                            ...
                            LOG.log(Level.SEVERE, "Error academic positions. " + ex.toString());
                        }
                    } 
                }
                catch(Exception ex)
            ...
            {
                LOG.info(this.iaux + " can't get GATE Data Extractor resource");
