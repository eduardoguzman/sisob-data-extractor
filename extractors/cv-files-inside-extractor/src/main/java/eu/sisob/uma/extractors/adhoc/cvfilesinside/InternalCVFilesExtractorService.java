...
public class InternalCVFilesExtractorService
{    
    private static final Logger LOG = Logger.getLogger(InternalCVFilesExtractorService.class.getName());
    
    //static final String LOG_NAME = "WebSearcherExtractor";
    
    private static InternalCVFilesExtractorService INSTANCE = null;
     ...
     *      
     */
    private InternalCVFilesExtractorService()
    {
    ...
    public synchronized static void createInstance() 
    {
        if (INSTANCE == null) 
        {             
            INSTANCE = new InternalCVFilesExtractorService();
        }
    }
     ...
     * @return
     */
    public static InternalCVFilesExtractorService getInstance() 
    {
        if (INSTANCE == null) 
        {
            createInstance();
