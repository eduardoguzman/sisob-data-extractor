...
public abstract class WebSearchersExtractorCommons {
    private static final Logger LOG = Logger.getLogger(WebSearchersExtractorCommons.class.getName());
    ...
    public void scrap_duckduckgo(File input_file, File output_file, File notfound_output_file, StringWriter error_sw)
    {
        ...
        LOG.info("Going to search researchers using duckduckgo");
        ...
        LOG.info("Headers info of result file writed");
        ...
        {            
            ...
            try
            {
                ...
                LOG.info("Researchers data info of results file writed");
