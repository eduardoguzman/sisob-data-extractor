...
{
    private static final Logger LOG = Logger.getLogger(AirResearchersWebPagesExtractor.class.getName());
    ...
    {        
        //Print result
        LOG.info("Researches results: Total :" + " - " + counterSuccess[2] + " / " + counterTotal[2] + " - Nº Depts: " + counterTotal[1] + " - Nº Depts with a least one res: " + counterSuccess[1]);
        
        
    }
    
    /**
     * In this block the crawler will try to extract the departments web addresses. 
    ...
    {                 
        ...
        {            
            ...
            LOG.info("\tAdding subject '" + sUnitOfAssessment_Description + "' to search its section webpages");                            
        }        
        ...
        try 
        {
            ...
            LOG.info("Begin crawling: " + sInstitutionName + " (" + sWebAddress + ") - [" + sSeed + "]");
            ...
            LOG.info("End crawling: " + sInstitutionName + " - Time: " + lTimerAux + " ms - [" + sSeed + "]");                
           ...
           for ( Iterator<org.dom4j.Element> i2 = elementInstitution.elementIterator(XMLTags.UNIT_OF_ASSESSMENT); i2.hasNext(); )
           {
               ...
               //    {
                       ...
                       if(lst != null)
                       {
                        ...
                        {
                            LOG.info("Add department '" + department_of + "' the url '" + ss.sURL + "'");
    ...
    {   
        ...
        {
            LOG.info("There is not dept webpages for [" + sUnitOfAssessment_Description + " - " + sInstitutionName + "]. Adding " + sWebAddress);
                        ...
                        for ( Iterator<org.dom4j.Element> researcher_it = research_group_element.elementIterator(XMLTags.RESEARCHER); researcher_it.hasNext(); )
                        {
                            ...
                            {                            
                                ...
                                for(CandidateTypeURL ss: lst)
                                {
                                    ...
                                    {                        
                                        LOG.info("Add researcher '" + researcher_name_info + "' the url '" + ss.sURL + "'");
                            ...
                            {
                                LOG.log(Level.WARNING, "No webpage for " + researcher_name_info);
                            }
                        }
                    }
                }
