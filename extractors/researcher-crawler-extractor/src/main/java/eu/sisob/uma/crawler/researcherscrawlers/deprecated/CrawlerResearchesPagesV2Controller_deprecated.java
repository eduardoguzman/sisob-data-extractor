...
{
    private static final Logger LOG = Logger.getLogger(CrawlerResearchesPagesV2Controller_deprecated.class.getName());
    ...
    {          
        try
        {
            ...
            {     
                ...
                {
                    LOG.info("\tREFUSE BY NOT FROM STAFFLIST OR SUB <" + c.sType + "> " + c.toString());
                    may_be_interesting_urls_detected.get(c.sType).add(c);
                    LOG.info("\tADD MAY BE <" + c.sType + "> " + c.toString());
