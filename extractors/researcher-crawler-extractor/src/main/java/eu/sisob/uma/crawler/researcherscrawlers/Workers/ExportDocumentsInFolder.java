 ...
 *  </infoblock>
 */
public class ExportDocumentsInFolder extends IteratorReseachersFile
{        
    private static final Logger LOG = Logger.getLogger(ExportDocumentsInFolder.class.getName());
     ...
     * @param destXmlFile
     */
    public ExportDocumentsInFolder(File source_file_xml, File downloadPagesDir, File dest_file_xml, LocalFormatType local_format_type)
    {
    ...
    protected boolean actionsInResearcherNode(Element elementResearcher, String path, String sInstitutionName, String sWebAddress, String sUnitOfAssessment_Description, String sResearchGroupDescription, ResearcherNameInfo researcherNameInfo, String sStaffIndentifier)
    {
        ...
        if(adirRW != null)
        {
            for ( File file : adirRW)
            {
                ...
                if(!b) LOG.log(Level.WARNING, "FILE MISSED: " + file.getPath());
            }
        }   
        return true;
    }
