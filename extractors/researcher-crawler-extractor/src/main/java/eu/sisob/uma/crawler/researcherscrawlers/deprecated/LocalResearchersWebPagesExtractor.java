...
{              
    private static final Logger LOG = Logger.getLogger(LocalResearchersWebPagesExtractor.class.getName());
    ...
    public static void P1_step_collectResearcherLinks(String xmlFilePath, int numberOfCrawlers, String sControlInstitutionName)
    {
        try
        {
            ...
            for ( Iterator i1 = root.elementIterator(XMLTags.INSTITUTION); i1.hasNext();)
            {
                ...
                LOG.info("Department phase - " + sInstitutionName);
                ...
                for ( Iterator i2 = e1.elementIterator(XMLTags.UNIT_OF_ASSESSMENT); i2.hasNext(); )
                {
                    ...
                    {
                        LOG.info("\tExist departments webaddress for " + sUnitOfAssessment_Description);
                    }
                    else
                    {
                        subjects.add(sUnitOfAssessment_Description);
                        LOG.info("\tNot exist departments webaddress for " + sUnitOfAssessment_Description);
                ...
                if(bNeedToSearchDeparmentWebAddress)
                {
                    ...
                    LOG.info("======================================================================");
                    LOG.info("Begin crawling: " + sInstitutionName + " (" + sWebAddress + ")");
                    ...
                    LOG.info("Extracting Links in: " + lTimerAux + " ms");
                    LOG.info("======================================================================");
                ...
                LOG.info("Researcher phase - " + sInstitutionName);
                ...
                for ( Iterator i2 = e1.elementIterator(XMLTags.UNIT_OF_ASSESSMENT); i2.hasNext(); )
                {
                    ...
                    if(lstDepartmentWebAddress.size() > 0)
                    {
                        ...
                        {
                            LOG.info("\tMiss researchers webaddress for " + sUnitOfAssessment_Description + ". Try to search.");
                            ...
                            LOG.info("======================================================================");
                            LOG.info("Begin crawling: " + sUnitOfAssessment_Description + " - " + sInstitutionName + " (" + sSeeds + ")");
                            long lTimerAux = java.lang.System.currentTimeMillis();
                            ...
                            LOG.info("Researches results: " + sInstitutionName + " - " +  sUnitOfAssessment_Description + " - " + counterSuccess[0] + " / " + counterTotal[0]);

                        }
                        else
                        {
                            LOG.info("\tExist researchers webaddress for " + sUnitOfAssessment_Description + ".");
                            ...
                            LOG.info("Results exist: " + sInstitutionName + " - " +  sUnitOfAssessment_Description + " - " + counterSuccess[0] + " / " + counterTotal[0]);
                        }
                    }
                    else
                    {
                        ...
                        if(counterSuccess[0] > 0)
                            ...
                            LOG.info("\tNot exist researchers webaddress for " + sUnitOfAssessment_Description + ".");
                ...
                if(bSaveFile)
                {
                    ...
                    bw.write(sOut);
                    bw.close();
                    LOG.info(xmlFile + " updated.");
                }
            }

            LOG.info("Researches results:" + counterSuccess[1] + " / " + counterTotal[1]);
        }
        catch(Exception ex)
        {
    ...
    public static void P1_checkEffectivityCollectResearcherLinks(String xmlFile, boolean showOnlyBad, float topPercent)
    {
        try
        {
            ...
            if(showOnlyBad)
            {
                LOG.info("Show only departments with less than " + topPercent + "%.\r\n");
            }
...
//                    }
                    ...
                    if(showOnlyBad)
                    {
                        ...
                        {
                            LOG.info("");
                            LOG.info("BAD RESULTS: " + sOut);
                            LOG.info("\tResearchers found: " + counterSuccess[0] + "/" + counterTotal[0] + "\t(" + percent + " %)");
                            LOG.info("\tFound: " + researchersText);
                            LOG.info("\tMiss: " + researchersMissText);
                        }
                    }
                    else
                    {
            ...
            LOG.info("");
            LOG.info("TOTAL Researchers found: " + counterSuccess[1] + "/" + counterTotal[1]);
        }
        catch(Exception ex)
        {
