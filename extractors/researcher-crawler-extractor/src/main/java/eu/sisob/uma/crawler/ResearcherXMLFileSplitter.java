...
{        
    private static final Logger LOG = Logger.getLogger(ResearcherXMLFileSplitter.class.getName());
    ...
    {   
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Cannot create xml file for " + split_file.getPath());
        }
