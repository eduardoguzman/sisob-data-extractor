...
{         
    private static final Logger LOG = Logger.getLogger(CrawlerResearchesPagesV3.class.getName());
    ...
    {           
        ...
        {          
            if(refController.crawler_trace != null)
            {
                ...
                {
                    LOG.info("\tTEXT: '" + associate_text + "' HREF: '" + href + "' HREF_PARENT: '" + parentURL + "'");    
                }
            }
            //FIXME
            boolean b = true;
    ...
    {   
        ...
        if(doc != null)
        {
            ...
            if(!els.isEmpty())
            {
                ...
                LOG.info("CV URL DETECTED => " + cv_url);      
            }
            ...
            {                
                ...
                LOG.info("PUBS URL DETECTED => " + pubs_url);      
            }
        }        
