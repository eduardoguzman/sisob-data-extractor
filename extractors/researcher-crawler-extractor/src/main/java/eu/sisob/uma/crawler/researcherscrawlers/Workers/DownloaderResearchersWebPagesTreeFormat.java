...
{
    private static final Logger LOG = Logger.getLogger(DownloaderResearchersWebPagesTreeFormat.class.getName());
                                                    ...
                                                    String destDir)
    {
        ...
        {            
            //if(true) return;           
            LOG.info("Begin to download and clean pages ("+destDir+")");
            FileFootils.deleteDir(destDir + System.getProperty("file.separator"));
        ...
        LOG.info("Download and clean pages end");
    }    
}
