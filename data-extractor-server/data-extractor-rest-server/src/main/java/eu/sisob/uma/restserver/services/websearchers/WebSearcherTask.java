...
public class WebSearcherTask 
{
    private static final Logger LOG = Logger.getLogger(WebSearcherTask.class.getName());
    ...
    {   
        ...
        {   
            ...
            if(validate)
            {
                ...
                WebSearcherExtractorTaskInRest task = new WebSearcherExtractorTaskInRest(user, task_code, code_task_folder, email, csv_data_source_file, csv_data_output_file, csv_data_output_file_unfounded, search_pattern);                                                         
