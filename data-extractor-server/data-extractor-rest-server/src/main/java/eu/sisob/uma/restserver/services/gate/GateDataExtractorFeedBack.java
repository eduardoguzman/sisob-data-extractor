...
public class GateDataExtractorFeedBack {
    private static final Logger LOG = Logger.getLogger(GateDataExtractorFeedBack.class.getName());        
    ...
    {     
        ...
        try {
            ...
            LOG.log(Level.SEVERE, "Error build feedback template: " + ex.toString());                
