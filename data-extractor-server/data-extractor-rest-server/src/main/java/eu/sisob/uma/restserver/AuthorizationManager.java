...
public class AuthorizationManager 
{
    ...
    static
    {                        
        //File dir = new File(TheConfig.getProperty("server.docs.folder") + File.separator + "docroot" + File.separator + TASKS_FOLDER_NAME);
        File dir = new File(TheConfig.getProperty("server.docs.folder") + File.separator + TASKS_FOLDER_NAME);
    ...
    {  
        ...
        try
        {
            ...
            {
                LOG.info("Results folder to notify error does not exist. (" + result_code_task_folder + ")");
                success = false;
            }
        }
        catch (Exception ex)
        {
            LOG.log(Level.SEVERE, "Error writing result errors (" + result_code_task_folder + ")", ex);
            success = false;
        }
